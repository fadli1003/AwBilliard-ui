...
export default function NotFound() {
  return (
    <div className="h-screen">
      <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8 dark:bg-neutral-950">
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <Link to='/contact' className="text-sm font-semibold text-gray-900 dark:text-white">
